...
class FloatingService : Service() {
    ...
    private fun startForegroundIfNeeded() {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            val chan = NotificationChannel(channelId, "FloatingDoubleTap", NotificationManager.IMPORTANCE_LOW)
        ...
        val notification: Notification = NotificationCompat.Builder(this, channelId)
            ...
            .setContentText("Tap the floating button to send taps")
    ...
    private fun createOverlay() {
        ...
        imageView.setOnTouchListener { _, event ->
            ...
            if (locked) {
                // If locked, ignore drag; still allow tap
    ...
    private fun performClickAtCurrentLocation(params: WindowManager.LayoutParams) {
        // Coordinates for dispatchGesture need screen coordinates
        ...
        view.post {
            ...
            // Send broadcast so accessibility service can execute tap sequence
